...
const AdminLayout = ({ children }) => {
  ...
  const adminNavigation = NAV_ITEMS.ADMIN;
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0E] flex layout-container">
              ...
              <div className="w-10 h-10 bg-linear-to-br from-primary to-[#94D44A] rounded-full flex items-center justify-center shadow-lg">
                {user?.avatar_url ? (
                  ...
                  <span className="text-[#0F0F0E] text-sm font-bold">
                    {user?.player_name?.charAt(0)?.toUpperCase() || "A"}
                  </span>
                )}
              </div>
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-h-0 content-wrapper transition-all duration-300">
        {/* Header */}
              ...
              <div className="relative notifications-menu">
                ...
                {notificationsOpen && (
                  <div className="absolute right-0 top-full mt-2 w-80 lg:w-96 bg-[#262626] border border-[#343434] rounded-xl lg:rounded-2xl shadow-2xl z-50 backdrop-blur-sm">
                    <div className="p-3 border-b border-[#343434]">
                      ...
                      {notifications.map((notification) => (
                        ...
                        >
                          <div className="flex justify-between items-start gap-2 lg:gap-3">
                            <div className="flex-1">
                              <h4 className="font-semibold text-white text-xs lg:text-sm group-hover:text-primary transition-colors">
                                {notification.title}
                              </h4>
                ...
                >
                  <div className="flex items-center space-x-2 lg:space-x-3">
                    ...
                    <div className="hidden sm:block text-left">
                      ...
                      <p className="text-primary text-xs">Administrator</p>
                    </div>
                  </div>
                  <ChevronDown
                    className={cn(
