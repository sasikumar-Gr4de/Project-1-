      ...
      <CardContent className="p-6">
        <div className="flex flex-col lg:flex-row items-start lg:items-center space-y-6 lg:space-y-0 lg:space-x-6">
          ...
          <div className="shrink-0">
            <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-2xl border-4 border-primary/20 bg-[#1A1A1A] overflow-hidden shadow-lg">
              {identity?.headshot_url ? (
                ...
                <div className="w-full h-full bg-linear-to-br from-primary to-[#94D44A] flex items-center justify-center">
                  <User className="w-12 h-12 text-[#0F0F0E]" />
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-3 lg:space-y-0">
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-[#B0AFAF]">
                  {/* Age */}
              ...
              {/* Season Info */}
              <div className="bg-[#1A1A1A] border border-[#343434] rounded-xl p-3 min-w-48">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-[#B0AFAF]">Season</span>
                    <span className="text-white font-semibold text-sm">
                      {passportData?.season || "2024-25"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-[#B0AFAF]">Squad Level</span>
                    <span className="text-white font-semibold text-sm">
            ...
            {(identity?.height_cm || identity?.weight_kg) && (
              <div className="flex items-center space-x-6 mt-4 pt-4 border-t border-[#343434]">
                {identity.height_cm && (
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">
                      {identity.height_cm}cm
                    </div>
                    <div className="text-xs text-[#B0AFAF]">Height</div>
                  </div>
                )}
                {identity.weight_kg && (
                  <div className="text-center">
                    ...
                    <div className="text-xs text-[#B0AFAF]">Weight</div>
                  </div>
                )}
                {identity.height_cm && identity.weight_kg && (
                  <div className="text-center">
                    ...
                    <div className="text-xs text-[#B0AFAF]">BMI</div>
                  </div>
                )}
              </div>
            )}
