    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Overall GR4DE Score</span>
                <div className="flex items-center space-x-2">
                  <Badge variant="outline">You: {latestScore || "--"}</Badge>
                  <Badge variant="secondary">Avg: 72</Badge>
                  <Badge variant="secondary">Top 10%: 88</Badge>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs">
                  <span className="text-muted-foreground">Bottom 10% (45)</span>
                  <span className="text-muted-foreground">Top 10% (88)</span>
                </div>
              </div>
            </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Badge variant="outline">You: {pillar.yourScore}</Badge>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <span>You</span>
                      <span>{pillar.yourScore}</span>
                    </div>
                    <Progress value={pillar.yourScore} className="h-2" />

                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>Average</span>
                      <span>{pillar.average}</span>
                    </div>
                    <Progress value={pillar.average} className="h-2 bg-muted" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <div>
                  <span className="font-medium">Physical Dominance</span>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <li className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <div>
                  <span className="font-medium">Mental Resilience</span>
                  <p className="text-sm text-muted-foreground">
