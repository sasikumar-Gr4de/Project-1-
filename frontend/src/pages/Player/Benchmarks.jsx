  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button
          asChild
          className="bg-linear-to-r ffrom-primary to-secondary text-(--ink) hover:from-secondary hover:to-primary font-semibold  rounded-lg px-4 py-2 h-10 text-sm shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
        >
          <Link to="/reports">
