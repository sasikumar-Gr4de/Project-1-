    ...
    insights: [
      {
        ...
        description:
          "Your conversion rate (33.3%) and clinical finishing in the box places you in the top 5% of strikers.",
      ...
      },
      {
        ...
        description:
          "Winning 75% of aerial duels with 2 headers attempted shows strong aerial presence.",
      ...
      },
      {
        ...
        description:
          "Making more runs in behind (currently 12) could create more goal-scoring opportunities.",
